...
import { FLAT_SERVICES, DEFAULT_SERVICE_ID, SERVICE_GROUPS } from '../services';
                    ...
                    {SERVICE_GROUPS.map((group) => (
                        <div key={group.id} className={styles.serviceGroup}>
                            ...
                            {group.services.map((svc) => {
                                const idx = FLAT_SERVICES.findIndex(s => s.id === svc.id);
                            ...
                            return (
                                <>
                                    <div className={styles.detailHeader}>
                                        <img src={svc.icon} alt="" className={styles.detailIcon} width={48} height={48} loading="lazy" decoding="async" />
