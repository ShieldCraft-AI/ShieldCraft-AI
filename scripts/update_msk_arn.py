...
def main():
    parser = argparse.ArgumentParser(
        description="Update MSK cluster ARN in environment config YAML."
    )
    parser.add_argument(
        "--env", required=True, help="Environment name (dev, staging, prod)"
    )
    ...
    parser.add_argument(
        "--export-name", help="CDK export name for the MSK cluster ARN (optional)"
    )
    parser.add_argument(
        "--config-dir",
        default="config",
