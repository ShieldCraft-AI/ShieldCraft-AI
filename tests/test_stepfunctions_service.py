"""
This module contains unit tests for the StepFunctionsStack class,
which synthesizes AWS Step Functions state machines based on a config-driven approach.
"""

import pytest
from aws_cdk import App, Stack
from infra.stacks.orchestration.stepfunctions_service import StepFunctionsStack
...
def test_stack_multiple_state_machines():
    ...
    app = App()
    StepFunctionsStack(app, "TestStack", env_name="dev", config=config)
