...
from infra.stacks.airbyte_stack import AirbyteStack
...
def test_airbyte_stack_outputs(airbyte_config):
    ...
    assert "TestAirbyteStackAirbyteALBDns" in outputs, f"ALB DNS output missing: {outputs.keys()}"
    assert "TestAirbyteStackAirbyteServiceName" in outputs, f"Service Name output missing: {outputs.keys()}"
    assert "TestAirbyteStackAirbyteLogGroupName" in outputs, f"Log Group output missing: {outputs.keys()}"
