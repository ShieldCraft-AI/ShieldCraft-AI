from aws_cdk import Stack, aws_lambda as _lambda, aws_glue as glue
...
class DataQualityStack(Stack):
    def __init__(
        ...
        dq_lambda_role_arn: str = None,
        dq_glue_role_arn: str = None,
        **kwargs,
    ):
        ...
        if dq_lambda_enabled:
            ...
            log_retention_enum = retention_map.get(
                lambda_log_retention, aws_logs.RetentionDays.ONE_WEEK
            )
            ...
            CfnOutput(
                ...
                value=self.dq_lambda.function_arn,
        ...
        if dq_glue_enabled:
            ...
            try:
                ...
                CfnOutput(
                    ...
                    value=self.glue_failure_alarm.alarm_arn,
